...
public class EnderecoServidor {
    ...
    public static String INFORMAR_OCORRENCIA = ip+"xmlInformarOcorrencia.php?idCard=";  // GET

    public static String OBTER_CP = ip+"xmlObterCP.php?cpf=";  // GET

    public static String OBTER_PONTOS = ip+"xmlObterPontos.php?idCard=";  // GET

    public static String OBTER_MANCHA = ip+"xmlObterMancha.php?type=2&dataStart=2014-02-01&dataFinish=2014-06-01";  // GET
